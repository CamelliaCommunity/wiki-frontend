	...
	<div class="w-full xl:w-content-width max-h-full mx-auto py-8">
		...
		<div class="flex flex-row w-full xl:w-content-width max-h-full mx-auto py-8">
			<div class="flex-column">
				<div class="flex flex-row cursor-pointer py-2 pl-4 pr-20 border-l-2
				 border-l-background-2 hover:border-l-accent">
					<PhUserGear class="size-8"></PhUserGear>
					<div class="px-2">
						<p class="text-xl font-medium">General</p>
						<p>Edit General Settings</p>
					</div>
				</div>
				<div class="flex flex-row cursor-pointer py-2 pl-4 pr-20 border-l-2
				 border-l-background-2 hover:border-l-accent">
				...
				<div class="flex flex-row cursor-pointer py-2 pl-4 pr-20 border-l-2
				 border-l-background-2 hover:border-l-accent">
					...
					<div class="px-2">
						...
						<p>Edit Account Privacy</p>
					</div>
				</div>
		    	<div class="gray-line opacity-40"></div>
				<div class="flex flex-row cursor-pointer py-2 px-2 pl-4 border-l-2
				 border-l-background-2 text-red fill-red hover:fill-accent-soft
			...
			<div class="flex-column  pl-2">
				<p class="">You may only edit profile pictures and banners in Discord!</p>
			</div>
		</div>
	</div>
</template>