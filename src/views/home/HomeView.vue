...
<template>
	<div class="w-full flex flex-col items-center justify-center gap-5">
		...
		<div class="flex flex-col md:flex-row w-full xl:w-content-width xl:mx-auto gap-5 md">
			<!-- removed the justify between. sorry emma :( - john -->
			<div class="flex w-full flex-col gap-4">
				...
				<!-- this is fucked up on purpose, dunno if scrolling should exist. sorry emma, again :( - john -->
				<div class="w-full flex flex-col gap-2 lg:max-h-full xl:max-h-81 overflow-y-auto max-h-full">
