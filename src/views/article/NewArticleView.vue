...
<template>
    <div class="article-page w-full xl:w-content-width">
        ...
        <div class="w-full flex flex-col gap-4 items-center">
            ...
            <BlockquoteNote class="w-full" type="caution" title="The requested article does not exist!">The Wiki does
                not have an
                article with this exact name. Please search for <a href="" class="text-accent readMoreHover">{{
                    react.meta.title }}</a> to
                check for alternative
                titles,
                spellings, or tags.
            </BlockquoteNote>
            <BlockquoteNote class="w-full" type="tip" title="A tip for you">If you would like to create an article
                within this location you must <a href="" class="text-accent readMoreHover">link your GitHub account.</a>
                Alternatively, you may request for a new
                article
                in <a href="https://discord.gg/camellia" class="text-accent readMoreHover">Discord</a> or head
                <a href="/" class="text-accent readMoreHover">Home</a>.
            </BlockquoteNote>
        </div>
    </div>
</template>
