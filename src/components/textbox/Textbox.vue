...
<template>
	<div class="h-auto w-full flex flex-col rounded-2xl bg-background-3 p-2 gap-2">
		<div class="w-full flex gap-2">
			<textarea
				class="transition h-10 w-full resize-none overflow-hidden rounded-lg bg-background-2 px-3 py-1 text-lg outline-none ring-background-2 hover:ring-1 focus:ring-2"
