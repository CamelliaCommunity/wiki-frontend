...
import { PhArrowFatUp, PhArrowFatDown, PhArrowBendUpLeft, PhDotsThree, PhPencil, PhTrash } from '@phosphor-icons/vue';
...
<template>
	<div class="bg-background-2 hover:bg-background-3 rounded-xl w-full max-w-screen-lg min-h-24 gap-2 px-2 py-2 flex m-auto"
		...
		<div class="flex flex-col w-full">
			<div class="flex text-xl justify-between gap-1 items-center align-middle">
				...
				<div class="bg-background-1 rounded hover:bg-background-2 cursor-pointer" v-if="comment.hovered">
					<PhDotsThree :size="24" />
				</div>
			</div>
