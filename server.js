...
app.use("*", async (req, res) => {
	try {
		...
		let errorHtml = `<div id="error">Uh-oh. A fatal error was encountered while loading Camellia Wiki.<br><br>Please report to the developers on our <a href="https://discord.gg/camellia">Discord</a>.</div>`;
		res.status(500).end(
